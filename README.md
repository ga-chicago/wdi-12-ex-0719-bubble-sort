...
Some commonly used sorting algorithms are `Quicksort`, `Merge Sort`, `Insertion Sort` and `Bubble Sort`. 
...
In today's folder, in a folder called `morning_exercise`, make a file `bubble_sort.js`
